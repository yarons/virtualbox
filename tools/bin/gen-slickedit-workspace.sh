# !kmk_ash
# $Id: gen-slickedit-workspace.sh 65589 2017-02-02 14:05:31Z noreply@oracle.com $
## @file
...
my_generate_project "openssl"       "src/libs/openssl-1.1.0d"               --begin-incs "include" "src/libs/openssl-1.1.0d/crypto"         --end-includes "src/libs/openssl-1.1.0d"
