# !kmk_ash
# $Id: gen-slickedit-workspace.sh 83931 2020-04-22 15:41:45Z alexander.rudnev@oracle.com $
## @file
...
my_generate_project "openssl"       "src/libs/openssl-1.1.1g"               --begin-incs "include" "src/libs/openssl-1.1.1g/crypto"         --end-includes "src/libs/openssl-1.1.1g"
