# !kmk_ash
# $Id: gen-slickedit-workspace.sh 64309 2016-10-18 09:13:23Z andreas.loeffler@oracle.com $
## @file
...
my_generate_project "openssl"       "src/libs/openssl-1.1.0b"               --begin-incs "include" "src/libs/openssl-1.1.0b/crypto"         --end-includes "src/libs/openssl-1.1.0b"
