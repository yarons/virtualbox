/* $Id: UIWizardNewVMNameOSTypePage.cpp 94052 2022-03-02 08:16:19Z serkan.bayraktar@oracle.com $ */
/** @file
...
void UIWizardNewVMNameOSTypePage::retranslateUi()
{
    ...
    if (m_pSkipUnattendedCheckBox)
    {
        ...
        m_pSkipUnattendedCheckBox->setToolTip(UIWizardNewVM::tr("Disables the unattended install and just mount the ISO."));
    }
