/* $Id: UIWizardNewVMNameOSTypePage.cpp 97852 2022-12-21 13:26:59Z alexander.eichner@oracle.com $ */
/** @file
...
static const osTypePattern gs_OSTypePattern[] =
{
    ...
    { QRegularExpression("((bookworm)|(trixie)|(sid)).*64",   QRegularExpression::CaseInsensitiveOption), "Debian_64" },
    { QRegularExpression("((bookworm)|(trixie)|(sid)).*32",   QRegularExpression::CaseInsensitiveOption), "Debian" },
