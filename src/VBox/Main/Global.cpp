/* $Id: Global.cpp 26366 2010-02-09 13:45:36Z noreply@oracle.com $ */
...
const Global::OSType Global::sOSTypes[SchemaDefs::OSTypeId_COUNT] =
{
    ...
    { "Linux",   "Linux",             SchemaDefs_OSTypeId_Oracle,          "Oracle",
      VBOXOSTYPE_Oracle,          VBOXOSHINT_NONE, 384,  12,  8 * _1K, NetworkAdapterType_Am79C973, 0 },
    { "Linux",   "Linux",             SchemaDefs_OSTypeId_Oracle_64,       "Oracle (64 bit)",
      VBOXOSTYPE_Oracle_x64,      VBOXOSHINT_64BIT | VBOXOSHINT_HWVIRTEX | VBOXOSHINT_IOAPIC,  384,  12,  8 * _1K, NetworkAdapterType_I82540EM, 0 },
    ...
    { "MacOS",  "Mac OS X",             SchemaDefs_OSTypeId_MacOS_64,          "Mac OS X (64 bit)",
      VBOXOSTYPE_MacOS_x64,       VBOXOSHINT_HWVIRTEX | VBOXOSHINT_IOAPIC | VBOXOSHINT_EFI | VBOXOSHINT_EXTHW |  VBOXOSHINT_64BIT ,  1024,   4,  20 * _1K, NetworkAdapterType_I82543GC, 0 },
};
