/* $Id: GuestSessionImplTasks.cpp 97531 2022-11-14 14:02:16Z andreas.loeffler@oracle.com $ */
/** @file
    ...
    while (itList != mVecLists.end())
    {
        ...
        if (pList->mSourceSpec.enmType == FsObjType_Directory)
        {
            ...
            while (itEntry != pList->mVecEntries.end())
            {
                ...
                /* Clean up the final host desitnation path. */
    ...
    while (itList != mVecLists.end())
    {
        ...
        if (pList->mSourceSpec.enmType == FsObjType_Directory)
        {
                   ...
                   && itEntry != pList->mVecEntries.end())
            {
                ...
                /* Clean up the final guest destination path. */
