/* $Id: ConsoleImplConfigX86.cpp 101465 2023-10-17 09:58:12Z alexander.eichner@oracle.com $ */
/** @file
...
#if 0 /* For now we only support running same-same architectures (e.g. x86 VMs on x86 hosts). */
