/* $Id: vkatCmdGeneric.cpp 91088 2021-09-02 11:53:54Z andreas.loeffler@oracle.com $ */
/** @file
...
static DECLCALLBACK(const char *) audioTestCmdEnumHelp(PCRTGETOPTDEF pOpt)
{
    switch (pOpt->iShort)
    {
        ...
        case VKAT_ENUM_OPT_PROBE_BACKENDS:      return "Specifies whether to probe all (available) backends until a working one is found\n"
                                                       "    Default: false";
        default:  return NULL;
    }
}
...
static DECLCALLBACK(RTEXITCODE) audioTestCmdPlayHandler(PRTGETOPTSTATE pGetState)
{
    ...
    while (cTestTones--)
    {
        ...
        ToneParms.uVolumePercent = 100; /** @todo Implement analyzing this first! */
