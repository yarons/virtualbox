#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: virtual_test_sheriff.py 93032 2021-12-20 18:38:09Z klaus.espenlaub@oracle.com $
...
class VirtualTestSheriff(object): # pylint: disable=too-few-public-methods
    ...
    def __init__(self):
        ...
        if self.oConfig.sLogFile:
            ...
            self.oLogFile.write('VirtualTestSheriff: $Revision: 93032 $ \n');
    ...
    def caseClosed(self, oCaseFile):
        ...
        for idTestResult, tReason in dReasonForResultId.items():
            ...
            if oFailureReason is not None:
                sComment = 'Set by $Revision: 93032 $' # Handy for reverting later.
