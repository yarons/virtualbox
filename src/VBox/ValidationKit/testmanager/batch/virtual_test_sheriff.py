#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: virtual_test_sheriff.py 61941 2016-06-29 17:12:28Z knut.osmundsen@oracle.com $
...
class VirtualTestSheriff(object): # pylint: disable=R0903
    ...
    def __init__(self):
        ...
        if self.oConfig.sLogFile is not None and len(self.oConfig.sLogFile) > 0:
            ...
            self.oLogFile.write('VirtualTestSheriff: $Revision: 61941 $ \n');
    ...
    def caseClosed(self, oCaseFile):
        ...
        for idTestResult, tReason in dReasonForResultId.items():
            ...
            if oFailureReason is not None:
                sComment = 'Set by $Revision: 61941 $' # Handy for reverting later.
