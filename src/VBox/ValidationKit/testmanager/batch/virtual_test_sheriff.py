#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: virtual_test_sheriff.py 67716 2017-06-30 07:49:49Z noreply@oracle.com $
...
class VirtualTestSheriff(object): # pylint: disable=R0903
    ...
    def __init__(self):
        ...
        if self.oConfig.sLogFile:
            ...
            self.oLogFile.write('VirtualTestSheriff: $Revision: 67716 $ \n');
    ...
    def caseClosed(self, oCaseFile):
        ...
        for idTestResult, tReason in dReasonForResultId.items():
            ...
            if oFailureReason is not None:
                sComment = 'Set by $Revision: 67716 $' # Handy for reverting later.
