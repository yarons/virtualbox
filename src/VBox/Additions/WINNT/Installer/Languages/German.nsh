; $Id: German.nsh 76953 2019-01-23 11:04:23Z andreas.loeffler@oracle.com $
;; @file
...
LangString VBOX_COMPONENT_D3D_OR_WDDM ${LANG_GERMAN}                "Fï¿½r diesen Gast ist Windows Aero (WDDM)-Unterstï¿½tzung verfï¿½gbar.$\r$\nDieses Feature ist jedoch noch experimentell und sollte daher noch nicht auf produktiven Systemen eingesetzt werden.$\r$\n$\r$\nMï¿½chten Sie stattdessen die regulï¿½re Direct3D-Unterstï¿½tzung installieren?"
