/* $Id: MMPhys.cpp 250 2007-01-23 17:12:21Z noreply@oracle.com $ */
/** @file
...
MMR3DECL(int) MMR3PhysRegisterEx(PVM pVM, void *pvRam, RTGCPHYS GCPhys, unsigned cb, unsigned fFlags, MMPHYSREG enmType, const char *pszDesc)
{
    ...
    else
    {
        ...
        rc = mmr3LockMem(pVM, pvRam, cb, MM_LOCKED_TYPE_PHYS, &pLockedMem, (enmType == MM_PHYS_TYPE_DYNALLOC_CHUNK) ? true : false /* fSilentFailure */);
        if (VBOX_SUCCESS(rc))
        {
