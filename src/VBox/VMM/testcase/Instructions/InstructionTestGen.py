#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 46554 2013-06-14 12:29:38Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 46554 2013-06-14 12:29:38Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
