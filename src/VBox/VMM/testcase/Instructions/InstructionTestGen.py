#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 46893 2013-07-01 20:38:16Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 46893 2013-07-01 20:38:16Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
