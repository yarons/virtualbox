#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 46746 2013-06-23 19:45:11Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 46746 2013-06-23 19:45:11Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
