#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 47286 2013-07-20 16:08:07Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 47286 2013-07-20 16:08:07Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
