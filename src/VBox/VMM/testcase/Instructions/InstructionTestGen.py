#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 49671 2013-11-26 18:09:07Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 49671 2013-11-26 18:09:07Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
