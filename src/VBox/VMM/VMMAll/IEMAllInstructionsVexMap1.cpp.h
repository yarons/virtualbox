/* $Id: IEMAllInstructionsVexMap1.cpp.h 66965 2017-05-19 09:38:05Z knut.osmundsen@oracle.com $ */
/** @file
...
FNIEMOP_DEF(iemOp_vmovlps_Vq_Hq_Mq__vmovhlps)
{
    ...
    else
    {
         ...
         */
        IEMOP_MNEMONIC3(VEX_RVM_MEM, VMOVLPS, vmovlps, Vq_WO, HqHi, Mq, DISOPTYPE_HARMLESS, IEMOPHINT_IGNORES_OP_SIZE);
