#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109145 2025-04-09 11:32:33Z knut.osmundsen@oracle.com $
...
class ArmInstruction(object):
    ...
    def getFieldByName(self, sName, fRaiseXpctIfNotFound = True):
        """ Looks up a named field in the aoEncodesets. """
        for oField in self.aoEncodesets:
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self, oVerInfo):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109145 2025-04-09 11:32:33Z knut.osmundsen@oracle.com $ ',
    ...
    def generateDecoderFunctions(self):
        ...
        class CExprHelper(object):
            ...
            def getFieldInfo(self, sName):
                oField = oInstr.getFieldByName(sName)
        ...
        for oInstr in g_aoAllArmInstructions:
            ...
            asArgs  = [];
            sLogFmt = '';
            for oField in sorted(oInstr.aoEncodesets, key = operator.attrgetter('iFirstBit')): # ArmEncodesetField
                if oField.sName:
