#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109076 2025-04-05 01:15:03Z knut.osmundsen@oracle.com $
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109076 2025-04-05 01:15:03Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
