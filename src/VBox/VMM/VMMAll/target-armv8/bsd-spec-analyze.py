#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109090 2025-04-08 00:21:04Z knut.osmundsen@oracle.com $
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109090 2025-04-08 00:21:04Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
