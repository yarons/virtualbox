#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109081 2025-04-07 10:24:37Z knut.osmundsen@oracle.com $
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109081 2025-04-07 10:24:37Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
