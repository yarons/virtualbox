#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109091 2025-04-08 01:04:50Z knut.osmundsen@oracle.com $
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109091 2025-04-08 01:04:50Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
