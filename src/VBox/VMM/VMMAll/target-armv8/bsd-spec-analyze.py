#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bsd-spec-analyze.py 109078 2025-04-06 02:25:04Z knut.osmundsen@oracle.com $
...
class IEMArmGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: bsd-spec-analyze.py 109078 2025-04-06 02:25:04Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
