/* $Id: IEMAllInstVexMap1.cpp.h 105184 2024-07-08 12:27:15Z alexander.eichner@oracle.com $ */
/** @file
...
FNIEMOP_DEF_1(iemOpCommonAvxAvx2_Vx_Hx_Wx, PCIEMOPMEDIAF3, pImpl)
{
    ...
    if (IEM_IS_MODRM_REG_MODE(bRm))
    {
        ...
        else
        {
            ...
            IEM_MC_ARG(PX86XMMREG,           puDst,  0);
            IEM_MC_REF_XREG_XMM(puDst,         IEM_GET_MODRM_REG(pVCpu, bRm));
