/* $Id: DrvHostAudioWasApi.cpp 108698 2025-03-10 19:09:35Z andreas.loeffler@oracle.com $ */
/** @file
                                              ...
                                              bool fOnWorker, PDRVHOSTAUDIOWASCACHEDEVCFG *ppDevCfg)
{
    *ppDevCfg = NULL;
    ...
    if (SUCCEEDED(hrc))
    {
        ...
        /* First, try retrieving the current device state here as a yet another meassure for
