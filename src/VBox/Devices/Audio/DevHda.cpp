/* $Id: DevHda.cpp 89853 2021-06-23 13:19:38Z knut.osmundsen@oracle.com $ */
/** @file
...
# endif
    ...
    for (uint8_t idxStream = 0; idxStream < RT_ELEMENTS(pThisCC->aStreams); idxStream++)
    {
        ...
        PDMDevHlpSTAMRegisterF(pDevIns, &pThisCC->aStreams[idxStream].State.StatDmaSkippedPendingBcis, STAMTYPE_COUNTER, STAMVISIBILITY_USED, STAMUNIT_COUNT,
