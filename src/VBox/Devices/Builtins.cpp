/** $Id: Builtins.cpp 9112 2008-05-26 10:11:34Z klaus.espenlaub@oracle.com $ */
/** @file
...
extern "C" DECLEXPORT(int) VBoxDriversRegister(PCPDMDRVREGCB pCallbacks, uint32_t u32Version)
{
    ...
    if (VBOX_FAILURE(rc))
        return rc;
#endif
#if defined(RT_OS_L4) || defined(RT_OS_LINUX) || defined(RT_OS_OS2) || (defined(RT_OS_SOLARIS) && !defined(__SunOS_5.10)) || defined(RT_OS_WINDOWS)
