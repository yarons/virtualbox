; $Id: VBoxVgaBiosAlternative8086.asm 109998 2025-06-26 12:35:18Z vadim.galitsyn@oracle.com $ 
;; @file
...
_msg_vga_init:                               ; 0xc4780 LB 0x31
    db  'Oracle VirtualBox Version 7.2.0_BETA2 VGA BIOS', 00dh, 00ah, 000h
...
_vbebios_product_revision:                   ; 0xc7e54 LB 0x26
    db  'Oracle VirtualBox Version 7.2.0_BETA2', 000h
