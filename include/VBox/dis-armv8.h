...
typedef enum DISOPPARAMARMV8VECREGTYPE
{
    ...
    /** @todo the element referencing is a bit hackish, feel free to refactor... */
    kDisOpParamArmV8VecRegType_D_Elem0,
    kDisOpParamArmV8VecRegType_D_Elem1,
    kDisOpParamArmV8VecRegType_S_Elem0,
    kDisOpParamArmV8VecRegType_S_Elem1,
    kDisOpParamArmV8VecRegType_S_Elem2,
    kDisOpParamArmV8VecRegType_S_Elem3,
    kDisOpParamArmV8VecRegType_H_Elem0,
    kDisOpParamArmV8VecRegType_H_Elem1,
    kDisOpParamArmV8VecRegType_H_Elem2,
    kDisOpParamArmV8VecRegType_H_Elem3,
    kDisOpParamArmV8VecRegType_H_Elem4,
    kDisOpParamArmV8VecRegType_H_Elem5,
    kDisOpParamArmV8VecRegType_H_Elem6,
    kDisOpParamArmV8VecRegType_H_Elem7,
    kDisOpParamArmV8VecRegType_B_Elem0,
    kDisOpParamArmV8VecRegType_B_Elem1,
    kDisOpParamArmV8VecRegType_B_Elem2,
    kDisOpParamArmV8VecRegType_B_Elem3,
    kDisOpParamArmV8VecRegType_B_Elem4,
    kDisOpParamArmV8VecRegType_B_Elem5,
    kDisOpParamArmV8VecRegType_B_Elem6,
    kDisOpParamArmV8VecRegType_B_Elem7,
    kDisOpParamArmV8VecRegType_B_Elem8,
    kDisOpParamArmV8VecRegType_B_Elem9,
    kDisOpParamArmV8VecRegType_B_Elem10,
    kDisOpParamArmV8VecRegType_B_Elem11,
    kDisOpParamArmV8VecRegType_B_Elem12,
    kDisOpParamArmV8VecRegType_B_Elem13,
    kDisOpParamArmV8VecRegType_B_Elem14,
    kDisOpParamArmV8VecRegType_B_Elem15,
    kDisOpParamArmV8VecRegType_End
